  ...
  return new Promise((resolve) => {
    ...
    const tdList: Td[] = Object.values(kfConfigList || {})
      ...
      .sort((tdData1: any, tdData2: any) => {
        ...
        return result === 0
          ? tdData1.account_id.localeCompare(tdData2.account_id)
          : result;
      });
...
export const getExistedMdSources = () =>
  getMdList().then((mdList: any) => {
