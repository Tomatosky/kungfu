...
import { KF_HOME, KF_CONFIG_DEFAULT_PATH, KF_CONFIG_PATH, KF_TARADING_CONFIG_DEFAULT_PATH, KF_TARADING_CONFIG_PATH, KF_ADMIN_PASSWORD_CONFIG_DEFAULT_PATH, KF_ADMIN_PASSWORD_CONFIG_PATH, KUNGFU_RESOURCES_DIR } from '__gConfig/pathConfig';
