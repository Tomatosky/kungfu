  ...
  >
    <div class="add-ticker-dialog__warp">
      <el-form ref="tickerForm" :model="tickerForm" label-width="70px">
        ...
        >
          <el-select size="mini" v-model.trim="tickerForm.exchangeId">
            <el-option
        ...
        >
          <el-select size="mini" v-model.trim="tickerForm.source">
            <el-option
    ...
    <div slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" size="mini" @click="handleSubmitSetting">
        确 定
      </el-button>
    </div>
  </el-dialog>
