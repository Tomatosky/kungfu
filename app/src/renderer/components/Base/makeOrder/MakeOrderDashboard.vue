  ...
  <tr-dashboard :title="`下单 ${currentId || ''}`">
    ...
    <div class="kf-make-order-window__body">
      <el-form ref="make-order-form" label-width="60px" :model="makeOrderForm">
        ...
        >
          <el-select
            v-model.trim="makeOrderForm.name"
        ...
        <el-form-item
          label="标的"
          prop="instrument_id"
          :rules="[{ required: true, message: '不能为空！', trigger: 'input' }]"
        >
          <el-autocomplete
        ...
        >
          <el-radio-group size="mini" v-model="makeOrderForm.offset">
            <el-radio
              size="mini"
              :class="{ 'red-radio': +key === 0, 'green-radio': +key !== 0 }"
        ...
        >
          <el-select size="mini" v-model="makeOrderForm.price_type">
            <el-option
              v-for="key in Object.keys(PriceType || {})"
              :value="+key"
              :label="PriceType[key]"
              :key="key"
            ></el-option>
          ...
          <el-col :span="14">
            ...
            >
              <el-input-number
                ...
                :controls="false"
                placeholder="请输入价格"
                v-model.trim="makeOrderForm.limit_price"
              ></el-input-number>
            </el-form-item>
          </el-col>
          <el-col :span="10">
