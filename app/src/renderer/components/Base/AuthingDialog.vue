...
[class*='authing-'].authing-ant-btn-primary:focus,
[class*='authing-'].authing-ant-btn-primary:hover {
  background: $vi;
  border-color: $vi;
}

[class*='authing-'].authing-guard-text-btn:focus,
[class*='authing-'].authing-guard-text-btn:hover {
  color: $vi;
}
...
[class*='authing-'].authing-ant-btn-background-ghost.authing-ant-btn-primary:focus,
[class*='authing-'].authing-ant-btn-background-ghost.authing-ant-btn-primary:hover {
  color: $vi;
  border-color: $vi;
}
