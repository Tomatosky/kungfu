  ...
  methods: {
    ...
    mergeMapByOrderId() {
      ...
      this.trades.kfForEach((item) => {
        ...
        const orderStatByOrderId = dealOrderStat(
          this.orderStat[orderId] || null,
        );
    ...
    turnOrderInputToLog(orderInput) {
      ...
      return `
                ...
                ${priceType} ${this.renderLine(
        'side',
        orderInput,
      )} ${this.renderLine('offset', orderInput)} ${hedgeFlag} <br/>
    ...
    turnOrderToLog(order) {
      ...
      return `
        ...
        'side',
        order,
      )} ${this.renderLine('offset', order)} ${hedgeFlag} <br/>
        ...
        trades
          .map(
            (trade) => `
                ...
                ${trade.instrumentId} ${trade.exchangeId} ${
              trade.accountId
            } <br/>
                ${this.renderLine('side', trade)} ${this.renderLine(
              'offset',
              trade,
            )} ${trade.hedgeFlag} <br/>
