...
window.admin = {
  login(password) {
    ...
    openVueWin('admin', '/', remote).then((win) => {
  ...
  resetPassword(oldpassword, newpassword) {
    ...
    const oldHashedPassword = kungfu.formatStringToHashHex(
    ...
    const newHashedPassword = kungfu.formatStringToHashHex(
