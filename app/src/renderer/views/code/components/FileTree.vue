...
.file-tree {
  ...
  .file-tree-body {
    ...
    ul > li > ul > li > div > span {
      padding-left: 20px;
    }
    ul > li > ul > li > ul > li > div > span {
      padding-left: 30px;
    }
    ul > li > ul > li > ul > li > ul > li > div > span {
      padding-left: 40px;
    }
    ul > li > ul > li > ul > li > ul > li > ul > li > div > span {
      padding-left: 50px;
    }
    ul > li > ul > li > ul > li > ul > li > ul > li > ul > li > div > span {
      padding-left: 60px;
    }
    ul
      > li
