...
KF_DEFINE_PACK_TYPE(                                                        //
    ...
    (double, funding_time),                 // 资金费时间
    (double, next_funding_time),            // 下一期资金费时间
...
KF_DEFINE_PACK_TYPE(                                                               //
    HistoryFundingRate, 408, PK(instrument_id, exchange_id), TIMESTAMP(data_time), //
