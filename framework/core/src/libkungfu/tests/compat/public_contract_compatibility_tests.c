...
typedef struct kf_embedding_api_v5_old {
  kf_embedding_api_v4_old v4;
...
int main(void) {
  ...
  if (!require(kungfu_embedding_get_api(1, sizeof(embedding_v1), &embedding_v1) == KF_OLD_OK,
      ...
      !require(kungfu_embedding_get_api(5, sizeof(embedding_v5), &embedding_v5) == KF_OLD_OK,
               "old embedding v5 consumer rejected") ||
      !require(embedding_v5.v4.v3.v2.v1.abi_version == 5 &&
                   embedding_v5.v4.v3.v2.v1.struct_size == sizeof(embedding_v5),
