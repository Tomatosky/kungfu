...
ATLAS_COMPLETION_COMMAND_CONTRACTS = {
    ...
    "kungfu.atlas.review-completion": {
        ...
        "signature": "kungfu atlas review-completion <mission-id> <goal-id> --reviewer <actor> --reviewer-source <source> [--source <source>] [--purpose <purpose>] [--cut-system-time <ns>] [--executor <profile>] [--follow-up <json>] --json",
    },
