...
| `libkungfu-contracts` | `ports-contracts` | `core/runtime-contracts` | 56 | `yijinjing`<br>`kungfu_contracts`<br>`kungfu` | `kungfu_runtime_error_tests`<br>`kungfu_durability_contract_tests` | `src/libkungfu/include/kungfu/runtime/common.h`<br>`src/libkungfu/include/kungfu/runtime/storage/service.h` |
...
| `libkungfu-cxx-source-surface` | `experimental` | `embedded-sqlite` | 54 | libkungfu<br>in-repository C++ bindings and applications |
