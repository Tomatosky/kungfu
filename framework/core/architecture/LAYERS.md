...
| `libkungfu-services` | `application-services` | `core/runtime-services` | 33 | `kungfu_services`<br>`kungfu_services_state_cache`<br>`kungfu` | `src/libkungfu/src/runtime/storage/service.cpp`<br>`src/libkungfu/src/runtime/state_service.cpp`<br>`src/libkungfu/src/runtime/query/fact_query.cpp` |
...
| `kungfu_services` | `OBJECT` | `libkungfu-services` | `kungfu_contracts` | 29 |
...
| --- | --- | ---: |
| Public storage facade, shared application helpers and compatibility surface | `src/libkungfu/src/runtime/storage/service.cpp` | 5000 |
