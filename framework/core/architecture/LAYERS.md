...
| `libkungfu-contracts` | `ports-contracts` | `core/runtime-contracts` | 59 | `yijinjing`<br>`kungfu_contracts`<br>`kungfu` | `kungfu_runtime_error_tests`<br>`kungfu_durability_contract_tests` | `src/libkungfu/include/kungfu/runtime/common.h`<br>`src/libkungfu/include/kungfu/runtime/storage/service.h` |
...
| `runtime-extension-services` | `application-services` | `core/runtime-extension` | 4 | `kungfu_extension_services`<br>`kungfu` | `kungfu_native_kfx_contract_tests`<br>`kungfu_profile_lifecycle_tests`<br>`kungfu_action_geometry_tests`<br>`kungfu_domain_profile_tests` | `src/libkungfu/src/runtime/kfx/native_registry.cpp`<br>`src/libkungfu/src/runtime/trust/assessment_runtime.cpp` |
...
| `libkungfu-cxx-source-surface` | `experimental` | `embedded-sqlite` | 60 | libkungfu<br>in-repository C++ bindings and applications |
