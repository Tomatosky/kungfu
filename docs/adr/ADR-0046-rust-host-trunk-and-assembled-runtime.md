...
- Related: [`docs/research/rust-host-spike.md`](../research/rust-host-spike.md)
  (the measured feasibility and cost evidence this decision stands on);
  [`docs/development/rust-adoption.md`](../development/rust-adoption.md) (this ADR is
...
4. **Measured, not argued.** The host-shell spike (`crates/host-spike`,
   [`docs/research/rust-host-spike.md`](../research/rust-host-spike.md)) proved
...
- **Rewrite the core or the domain layer in Rust.** Out of scope and against
  ...
  ([`docs/development/rust-adoption.md`](../development/rust-adoption.md)).
