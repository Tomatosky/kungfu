...
- Status: proposed; implementation in this change
- Date: 2026-07-15
...
- Related: [SHIFU-ADR-0004](./SHIFU-ADR-0004-gate-control-plane-contract.md),
  [SHIFU-ADR-0005](./SHIFU-ADR-0005-repo-root-discovery-and-jurisdiction.md),
  and [ADR-0076](./ADR-0076-documentation-directory-authority.md)
