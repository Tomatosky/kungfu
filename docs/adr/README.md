...
| [0086](ADR-0086-versioned-product-runtime-upgrade-control-plane.md) | accepted | product upgrades install verified immutable runtime images first; Core alone plans, fences, activates, rolls back, and reference-collects generations for GUI and CLI |
