...
| [0084](ADR-0084-codex-app-server-structured-hybrid-adapter.md) | accepted | Codex App Server is an exact-version structured-hybrid adapter over the shared Agent Interaction Port, with attempt-level PTY fallback and fail-closed schema drift |
