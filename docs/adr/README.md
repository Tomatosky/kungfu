...
| [0112](ADR-0112-xinfa-native-semantic-project-authority.md) | accepted | Project declarations and Shifu exact discovery feed one Xinfa-owned semantic project materializer with no duplicate graph authority |
