...
| What is Xinfa, which context-compiler semantics does it own, and how is its standalone boundary proved? | [`../xinfa/`](../xinfa/) + [ADR-0092](adr/ADR-0092-xinfa-product-and-incubation-boundary.md) | why, use, verify | incubation · product identity and clean extraction boundary implemented; compiler staged |
