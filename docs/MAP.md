...
| What is the backend-neutral identity and history contract for Fact objects, versions, relations, Cuts, refs, CAS, and receipts? | [ADR-0112](./adr/ADR-0112-backend-neutral-fact-cut-kernel.md) + `kungfu contract show fact-cut-kernel --json` | why, use, verify | accepted contract · authoritative writer and release qualification not implemented |
