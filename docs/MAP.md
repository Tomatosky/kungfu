...
| How do I check whether runtime, Peers, storage, and Episodes are safe before ordinary work? | [`health.md`](guides/health.md) + [ADR-0106](./adr/ADR-0106-unified-read-only-product-diagnostics.md) | use, verify | pre-release · fast/deep read-only contract and three-platform CI gate implemented |
