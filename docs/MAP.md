...
| Which Kungfu layer can I adopt independently, and what does each product promise? | [`product-layers.md`](concepts/product-layers.md) + [ADR-0049](./adr/ADR-0049-layer-complete-products-and-domain-neutral-core.md) | why, use, verify | draft · principle accepted; qualifications staged |
