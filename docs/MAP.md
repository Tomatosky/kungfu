...
| How could Fact and Episode form the runtime substrate for Pursuit, Atlas, and Warrant while preserving the current Agent Work State authority? | [`fact-episode-action-runtime.md`](architecture/fact-episode-action-runtime.md) + [ADR-0109](./adr/ADR-0109-four-object-agent-work-state-contract.md) | why, use, verify | proposed design · current ADR and machine contract remain authoritative |
