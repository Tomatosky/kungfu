...
| How do I plan and execute safe recovery without learning every internal service command? | [`recovery.md`](guides/recovery.md) + [ADR-0108](./adr/ADR-0108-fenced-unified-recovery-entry.md) | use, verify | pre-release · fenced CLI candidate; integration pending |
