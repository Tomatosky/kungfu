...
| How do I manage a long-running Mission, delegate Go work, inspect Cost/State/Proof, move the evidence to another data root, and cut over from an Atlas bridge? | [`mission-control.md`](profiles/mission-control.md) + [ADR-0059](./adr/ADR-0059-mission-control-mission-go-responsibility-model.md) + [ADR-0104](./adr/ADR-0104-native-mission-go-authority-cutover.md) | why, use, verify | pre-release · native authoring, local full/thin bundle roundtrip, and audited authority migration implemented |
