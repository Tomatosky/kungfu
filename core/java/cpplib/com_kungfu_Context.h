 ...
 * Class:     com_kungfu_Context
 * Method:    make_order
 * Signature: (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;DJLcom/kungfu/PriceType;Lcom/kungfu/Side;Lcom/kungfu/Offset;Lcom/kungfu/HedgeFlag;)J
 */
JNIEXPORT jlong JNICALL Java_com_kungfu_Context_make_1order
  (JNIEnv *, jobject, jstring, jstring, jstring, jstring, jdouble, jlong, jobject, jobject, jobject, jobject);
