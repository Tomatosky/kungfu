...
using namespace kungfu::yijinjing::os;

static std::unique_ptr<Runner> runner_ = {};
static Strategy_ptr strategy_proxy_ = {};
...
public:
  ...
  void pre_start(Context_ptr &context) override {
    ...
    jmethodID method_pre_start = env_->GetMethodID(handler_class, "pre_start", "(Lcom/kungfu/Context;)V");
  ...
  void post_start(Context_ptr &context) override {
    jclass handler_class = env_->GetObjectClass(handler_);
    jmethodID method_post_start = env_->GetMethodID(handler_class, "post_start", "(Lcom/kungfu/Context;)V");
  ...
  void on_quote(Context_ptr &context, const kungfu::longfist::types::Quote &quote) override {
    jclass handler_class = env_->GetObjectClass(handler_);
    jmethodID method_on_quote =
        env_->GetMethodID(handler_class, "on_quote", "(Lcom/kungfu/Context;Lcom/kungfu/Quote;)V");
    ...
    jfieldID fid_instrument_type = env_->GetStaticFieldID(
        clazz_InstrumentType, kungfu::wingchun::str_from_instrument_type(quote.instrument_type).c_str(),
    ...
    jmethodID quote_constructor = env_->GetMethodID(clazz_quote, "<init>",
                                                    "(Ljava/lang/String;Ljava/lang/String;JLjava/lang/String;Ljava/"
  ...
  void on_order(Context_ptr &context, const kungfu::longfist::types::Order &order) override {
    jclass handler_class = env_->GetObjectClass(handler_);
    jmethodID method_on_order =
        env_->GetMethodID(handler_class, "on_order", "(Lcom/kungfu/Context;Lcom/kungfu/Order;)V");
    ...
    jfieldID fid_volumecondition =
        env_->GetStaticFieldID(clazz_volumecondition, str_from_volumecondition(order.volume_condition).c_str(),
                               "Lcom/kungfu/VolumeCondition;");
    ...
    jobject obj_order = env_->NewObject(
        clazz_order, order_constructor, parent_id, order_id, insert_time, update_time, trading_day, instrument_id,
        exchange_id, source_id, account_id, client_id, obj_instrument_type, limit_price, frozen_price, volume,
        volume_traded, volume_left, tax, commission, obj_status, error_id, error_msg, obj_side, obj_offset,
  ...
  void on_history_order(Context_ptr &context, const kungfu::longfist::types::HistoryOrder &order) override {
    jclass handler_class = env_->GetObjectClass(handler_);
    jmethodID method_on_history_order =
        env_->GetMethodID(handler_class, "on_history_order", "(Lcom/kungfu/Context;Lcom/kungfu/HistoryOrder;)V");
    ...
    jmethodID order_constructor = env_->GetMethodID(
        clazz_order, "<init>",
        "(JJJJLjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;ZLcom/kungfu/"
        "InstrumentType;DDJJJDDLcom/kungfu/OrderStatus;ILjava/lang/String;Lcom/kungfu/Side;Lcom/kungfu/Offset;Lcom/"
        "kungfu/HedgeFlag;Lcom/kungfu/PriceType;Lcom/kungfu/VolumeCondition;Lcom/kungfu/TimeCondition;)V");
    jobject obj_order = env_->NewObject(
        clazz_order, order_constructor, parent_id, order_id, insert_time, update_time, trading_day, instrument_id,
        exchange_id, source_id, account_id, is_last, obj_instrument_type, limit_price, frozen_price, volume,
        volume_traded, volume_left, tax, commission, obj_status, error_id, error_msg, obj_side, obj_offset,
        obj_hedgeflag, obj_pricetype, obj_volumecondition, obj_timecondition);
  ...
  void on_trade(Context_ptr &context, const kungfu::longfist::types::Trade &trade) override {
    jclass handler_class = env_->GetObjectClass(handler_);
    jmethodID method_on_trade =
        env_->GetMethodID(handler_class, "on_trade", "(Lcom/kungfu/Context;Lcom/kungfu/Trade;)V");
  ...
  void on_history_trade(Context_ptr &context, const kungfu::longfist::types::HistoryTrade &trade) override {
    jclass handler_class = env_->GetObjectClass(handler_);
    jmethodID method_on_history_trade =
        env_->GetMethodID(handler_class, "on_history_trade", "(Lcom/kungfu/Context;Lcom/kungfu/HistoryTrade;)V");
  ...
  void on_deregister(Context_ptr &context, const kungfu::longfist::types::Deregister &deregister) {
    jclass handler_class = env_->GetObjectClass(handler_);
    jmethodID method_on_deregister =
        env_->GetMethodID(handler_class, "on_deregister", "(Lcom/kungfu/Context;Lcom/kungfu/Deregister;)V");
    ...
    jfieldID fid_category =
        env_->GetStaticFieldID(clazz_category, str_from_category(deregister.category).c_str(), "Lcom/kungfu/Category;");
    ...
    jmethodID deregister_constructor = env_->GetMethodID(
        clazz_deregister, "<init>", "(ILcom/kungfu/Category;Lcom/kungfu/Mode;Ljava/lang/String;Ljava/lang/String;)V");
  ...
  void on_broker_state_change(Context_ptr &context, const kungfu::longfist::types::BrokerStateUpdate &brokerStateUpdate,
    ...
    jclass handler_class = env_->GetObjectClass(handler_);
    jmethodID method_on_broker_state_change =
        env_->GetMethodID(handler_class, "on_broker_state_change",
                          "(Lcom/kungfu/Context;Lcom/kungfu/BrokerStateUpdate;Lcom/kungfu/Location;)V");
    ...
    jfieldID fid_brokerstate = env_->GetStaticFieldID(
        clazz_brokerstate, str_from_brokerstate(brokerStateUpdate.state).c_str(), "Lcom/kungfu/BrokerState;");
    ...
    jmethodID brokerstateupdate_constructor =
        env_->GetMethodID(clazz_brokerstateupdate, "<init>", "(Lcom/kungfu/BrokerState;)V");
    ...
    jclass clazz_category = env_->FindClass("com/kungfu/Category");
    jfieldID fid_category =
        env_->GetStaticFieldID(clazz_category, str_from_category(location->category).c_str(), "Lcom/kungfu/Category;");
    jobject obj_category = env_->GetStaticObjectField(clazz_category, fid_category);
...
inline bool check_runner_init(JNIEnv *env) {
  if (runner_) {
    return true;
  }
  JAVA_THROW_RUNTIME_EXCEPTION("Runner not initialized");
  return false;
}

inline bool check_runner_setup(JNIEnv *env) {
  if (not check_runner_init(env)) {
    return false;
  }
  if (runner_->is_live()) {
    JAVA_THROW_RUNTIME_EXCEPTION("Runner is already setup");
    return false;
  }
  return true;
}

inline bool check_runner_running(JNIEnv *env) {
  if (not check_runner_init(env)) {
    return false;
  }
  if (not runner_->is_live()) {
    JAVA_THROW_RUNTIME_EXCEPTION("Runner is not setup");
    return false;
  }
  return true;
}
...
extern "C" JNIEXPORT void JNICALL Java_com_kungfu_Runner_init(JNIEnv *env, jobject self, jstring group, jstring name) {
  if (runner_) {
    JAVA_THROW_RUNTIME_EXCEPTION("Init kungfu runner more than once");
    return;
  }

  disable_os_signals_handler();

  std::string g = jstring2string(env, group);
  std::string n = jstring2string(env, name);
  runner_ = std::make_unique<Runner>(std::make_shared<locator>(), g.c_str(), n.c_str(), mode::LIVE, false);

  strategy_proxy_ = std::make_shared<StrategyProxy>(env, self);
  runner_->add_strategy(strategy_proxy_);
}
