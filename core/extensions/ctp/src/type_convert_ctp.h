...
inline void to_ctp_price_type(TThostFtdcOrderPriceTypeType &price_type, TThostFtdcVolumeConditionType &volume_condition,
                              TThostFtdcTimeConditionType &time_condition, const PriceType &ori) {
...
inline void from_ctp_price_type(const TThostFtdcOrderPriceTypeType &price_type,
                                const TThostFtdcVolumeConditionType &volume_condition,
                                const TThostFtdcTimeConditionType &time_condition, PriceType &des) {
...
inline void from_ctp_order_status(const TThostFtdcOrderStatusType &order_status,
                                  const TThostFtdcOrderSubmitStatusType &submit_status, OrderStatus &des) {
  switch (order_status) {
